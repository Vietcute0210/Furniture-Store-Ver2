  ...
  <div class="container py-5">
    ...
    >
      <div class="row g-4">
        <div class="col-lg-3">
          <a href="#">
            <h1 class="text-primary mb-0">FURNITURE</h1>
        ...
        <div class="col-lg-3">
          <div class="d-flex justify-content-end pt-3">
            <a
              ...
              href="https://www.instagram.com/vietcute0210"
              target="_blank"
            >
            ...
            <a
              class="btn btn-outline-secondary me-2 btn-md-square rounded-circle"
              href="https://www.facebook.com/share/16qhxr73db/"
              target="_blank"
    ...
    <div class="row g-5">
      ...
      <div class="col-lg-3 col-md-6">
        <div class="footer-item">
          ...
          <p>Address: km10 Nguyễn Trãi - Hà Đông - Hà Nội</p>
          <p>Email: vietqhoa0210@gmail.com</p>
          <p>Phone: +84348395215</p>
    ...
    <div class="row">
      <div class="col-md-6 text-center text-md-start mb-3 mb-md-0">
        <span class="text-light"
          ><a href="#"
            ><i class="fas fa-copyright text-light me-2"></i>Vietcute0210 </a
