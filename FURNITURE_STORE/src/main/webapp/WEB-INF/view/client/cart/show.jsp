                                            ...
                                            <form:form action="/order/checkout" method="post" modelAttribute="cart">
                                                ...
                                                <div style="display: none;">
                                                    <c:forEach var="cartDetail" items="${cart.cartDetails}"
                                                        varStatus="status">
                                                        <!-- Đoạn này phải dùng cart.cartDetails do nếu dùng mỗi cartDetails thì nó không hiểu được -->
                                                        <!-- Status mình dùng để lấy ra chỉ số của mảng => Cho mình biết đang ở phần tử thứ bnhieu -->
                                                        <div class="mb-3">
